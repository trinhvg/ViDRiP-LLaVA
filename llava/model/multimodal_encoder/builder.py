...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    if is_absolute_path_exists or vision_tower.startswith("openai") or vision_tower.startswith("laion") or vision_tower.startswith("wisdomik") or "ShareGPT4V" in vision_tower:
        if use_s2:
