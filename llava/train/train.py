...
from llava.utils import rank0_print, process_video_with_pyav, process_video_with_decord, process_video_with_decord_center
...
class DataArguments:
    ...
    video_center_crop: Optional[float] = field(default=0)
...
def preprocess_qwen(sources, tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False, max_len=2048, system_message: str = "You are a helpful assistant.") -> Dict:
    ...
    # print("Special additional_special_tokens_ids:",  tokenizer.additional_special_tokens_ids)
    # Special token IDs differ in Qwen 2.0 and 2.5; set these based on the version
    if qwen_version == "2.5":
        ...
        if "image" in sources[0]:
            ...
            try:
                if "shareVideoGPTV" in video_file:
                    ...
                    if self.data_args.video_center_crop > 0:
                        video, video_time, frame_time, num_frames_to_sample = process_video_with_decord_center(video_file, self.data_args)
                    else:
