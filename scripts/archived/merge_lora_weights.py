    ...
    if "llava" in model_name.lower() or is_multimodal:
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                ...
                if model_base == "lmms-lab/llava-onevision-qwen2-7b-ov":
                    lora_cfg_pretrained.vocab_size = 152064
            ...
            if "mixtral" in model_name.lower():
                ...
                or "llava-ov" in model_name.lower()
            ):
                from llava.model.language_model.llava_llama import LlavaConfig
...
if __name__ == "__main__":
    ...
    # model_path_dir       = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision_sc_v1.0"
    # args.model_path      = f"{model_path_dir}/llava-onevision-siglip-Qwen2-7B-Instruct-ov_PathResVL_instruct_SC_video_v1.0_gpt4o_mini_diagnosis_short_yolo_bs2_from_from_lmms-lab_llava-onevision-qwen2-7b-ov_lora"
    # args.model_base      = "lmms-lab/llava-onevision-qwen2-7b-ov"
    # args.save_model_path = f"{model_path_dir}/llava-onevision-siglip-Qwen2-7B-Instruct-ov_PathResVL_instruct_SC_video_v1.0_gpt4o_mini_diagnosis_short_yolo_bs2_from_from_lmms-lab_llava-onevision-qwen2-7b-ov_lora_merge"

    # model_path_dir       = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision_sc_v1.0"
    # args.model_path      = f"{model_path_dir}/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_SC_video_v1.0_gpt4o_mini_diagnosis_short_yolo_bs2_from_im+clip_lora"
    # args.model_base      = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_video_chunk_yolo_gpt4o_train_cls33_all+2dms-anyres_bs2"
    # args.save_model_path = f"{model_path_dir}/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_SC_video_v1.0_gpt4o_mini_diagnosis_short_yolo_bs2_from_im+clip_lora_merge"

    # model_path_dir       = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision_sc"
    # args.model_path      = f"{model_path_dir}/llava-onevision-siglip-Qwen2-7B-Instruct-ov_PathResVL_instruct_SC_video_v0_bs2_from_lmms-lab_llava-onevision-qwen2-7b-ov_lora"
    # args.model_base      = "lmms-lab/llava-onevision-qwen2-7b-ov"
    # args.save_model_path = f"{model_path_dir}/llava-onevision-siglip-Qwen2-7B-Instruct-ov_PathResVL_instruct_SC_video_v0_bs2_from_lmms-lab_llava-onevision-qwen2-7b-ov_lora_merge"
    #
    # model_path_dir       = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision_sc_v1.0"
    # args.model_path      = f"{model_path_dir}/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_SC_video_v1.0_gpt4o_mini_diagnosis_short_yolo_bs2_from_stage1_im_lora"
    # args.model_base      = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_video_chunk_yolo_gpt4o_train_cls33_all+2dms-anyres_bs2"
    # args.save_model_path = f"{model_path_dir}/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_SC_video_v1.0_gpt4o_mini_diagnosis_short_yolo_bs2_from_stage1_im_lora_merge"
    #

    # config  = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision_sc/llava-onevision-siglip-Qwen2-7B-Instruct-ov_PathResVL_instruct_SC_video_v0_bs2_from_lmms-lab_llava-onevision-qwen2-7b-ov"
    #
    # vocab_size = 152064


    model_path_dir       = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision_sc"
    args.model_path      = f"{model_path_dir}/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_SC_video_v0_bs2_from_stage2_im_lora"
    args.model_base      = "lmms-lab/llava-onevision-qwen2-7b-ov"
    args.save_model_path = f"{model_path_dir}/llava-onevision-siglip-Qwen2.5-7B-Instruct-ov_PathResVL_instruct_SC_video_v0_bs2_from_stage2_im_lora_merge"


    # model_path_dir       = "/data1/trinh/code/ViLa/video/LLaVA-NeXT/checkpoints/onevision_sc_v1.0"
    # args.model_path      = f"{model_path_dir}/llava-onevision-siglip-Qwen2-7B-Instruct-ov_PathResVL_instruct_SC_video_v0_bs2_from_lmms-lab_llava-onevision-qwen2-7b-ov"

    # import json
    #
    # # Read the existing config.json file
    # with open(f'{args.model_path}/config.json', 'r') as file:
    #     config = json.load(file)
    #
    # # Add or update the vocab_size field
    # config['vocab_size'] = 152064
    #
    # # Write the updated config back to the file
    # with open(f'{args.model_path}/config.json', 'w') as file:
    #     json.dump(config, file, indent=4)
    #
    # print("vocab_size added/updated successfully!")
